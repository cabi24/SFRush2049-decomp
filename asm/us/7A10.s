...
nonmatching osSetEventMesgAlt, 0xB4

glabel osSetEventMesgAlt
    ...
    /* 7A24 80006E24 0C00312C */  jal        __osDisableInt
    /* 7A28 80006E28 AFB00018 */   sw        $s0, 0x18($sp)
    /* 7A2C 80006E2C 8FAE0028 */  lw         $t6, 0x28($sp)
    /* 7A30 80006E30 3C188003 */  lui        $t8, %hi(__osEventStateTab)
    /* 7A34 80006E34 8FA8002C */  lw         $t0, 0x2C($sp)
    /* 7A38 80006E38 27186710 */  addiu      $t8, $t8, %lo(__osEventStateTab)
    ...
    /* 7A6C 80006E6C 3C0C8003 */  lui        $t4, %hi(__osShutdown)
    /* 7A70 80006E70 8D8CC36C */  lw         $t4, %lo(__osShutdown)($t4)
    /* 7A74 80006E74 11800009 */  beqz       $t4, .L80006E9C
    /* 7A78 80006E78 00000000 */   nop
    /* 7A7C 80006E7C 3C0D8003 */  lui        $t5, %hi(gEventTypeFlag)
    /* 7A80 80006E80 8DADC350 */  lw         $t5, %lo(gEventTypeFlag)($t5)
    ...
    /* 7A94 80006E94 0C001D78 */  jal        osJamMesg
    /* 7A98 80006E98 00003025 */   or        $a2, $zero, $zero
  .L80006E9C:
    /* 7A9C 80006E9C 240E0001 */  addiu      $t6, $zero, 0x1
    /* 7AA0 80006EA0 3C018003 */  lui        $at, %hi(gEventTypeFlag)
    /* 7AA4 80006EA4 AC2EC350 */  sw         $t6, %lo(gEventTypeFlag)($at)
  .L80006EA8:
    /* 7AA8 80006EA8 0C003148 */  jal        __osRestoreInt
