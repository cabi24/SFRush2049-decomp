nonmatching dll_update, 0x178

glabel dll_update
    /* CD1C 8000C11C 3C0E8003 */  lui        $t6, %hi(__osTimerList)
    /* CD20 8000C120 8DCEC3F0 */  lw         $t6, %lo(__osTimerList)($t6)
  ...
  .L8000C138:
    /* CD38 8000C138 3C188003 */  lui        $t8, %hi(__osTimerList)
    /* CD3C 8000C13C 8F18C3F0 */  lw         $t8, %lo(__osTimerList)($t8)
    /* CD40 8000C140 8F190000 */  lw         $t9, 0x0($t8)
    /* CD44 8000C144 17380006 */  bne        $t9, $t8, .L8000C160
    /* CD48 8000C148 AFB90024 */   sw        $t9, 0x24($sp)
    /* CD4C 8000C14C 0C003EE4 */  jal        __osSetCompare
    /* CD50 8000C150 00002025 */   or        $a0, $zero, $zero
    /* CD54 8000C154 3C018003 */  lui        $at, %hi(__osTimerCounter)
    /* CD58 8000C158 1000004A */  b          .L8000C284
    /* CD5C 8000C15C AC207C60 */   sw        $zero, %lo(__osTimerCounter)($at)
  .L8000C160:
    /* CD60 8000C160 0C00325C */  jal        osGetCount
    /* CD64 8000C164 00000000 */   nop
    /* CD68 8000C168 AFA20020 */  sw         $v0, 0x20($sp)
    /* CD6C 8000C16C 3C098003 */  lui        $t1, %hi(__osTimerCounter)
    /* CD70 8000C170 8D297C60 */  lw         $t1, %lo(__osTimerCounter)($t1)
    /* CD74 8000C174 8FA80020 */  lw         $t0, 0x20($sp)
    /* CD78 8000C178 8FAF0024 */  lw         $t7, 0x24($sp)
    /* CD7C 8000C17C 3C018003 */  lui        $at, %hi(__osTimerCounter)
    /* CD80 8000C180 01095023 */  subu       $t2, $t0, $t1
    /* CD84 8000C184 AFAA001C */  sw         $t2, 0x1C($sp)
    /* CD88 8000C188 AC287C60 */  sw         $t0, %lo(__osTimerCounter)($at)
  ...
  .L8000C1C0:
    ...
    /* CDF0 8000C1F0 0C0030A5 */  jal        dll_reschedule
  ...
  .L8000C200:
    ...
    /* CE48 8000C248 0C001D78 */  jal        osJamMesg
  ...
  .L8000C26C:
    ...
    /* CE74 8000C274 0C0030C2 */  jal        dll_insert
