nonmatching dll_insert, 0x188

glabel dll_insert
    /* CF08 8000C308 27BDFFC8 */  addiu      $sp, $sp, -0x38
    /* CF0C 8000C30C AFBF0014 */  sw         $ra, 0x14($sp)
    /* CF10 8000C310 0C00312C */  jal        __osDisableInt
    /* CF14 8000C314 AFA40038 */   sw        $a0, 0x38($sp)
    /* CF18 8000C318 3C0E8003 */  lui        $t6, %hi(__osTimerList)
    /* CF1C 8000C31C 8DCEC3F0 */  lw         $t6, %lo(__osTimerList)($t6)
  ...
  .L8000C368:
    ...
    /* CF84 8000C384 3C188003 */  lui        $t8, %hi(__osTimerList)
    ...
    /* CFA4 8000C3A4 8F18C3F0 */  lw         $t8, %lo(__osTimerList)($t8)
  ...
  .L8000C3E4:
    ...
    /* CFF0 8000C3F0 3C188003 */  lui        $t8, %hi(__osTimerList)
    /* CFF4 8000C3F4 AF280010 */  sw         $t0, 0x10($t9)
    /* CFF8 8000C3F8 AF290014 */  sw         $t1, 0x14($t9)
    /* CFFC 8000C3FC 8F18C3F0 */  lw         $t8, %lo(__osTimerList)($t8)
  ...
  .L8000C43C:
    ...
    /* D074 8000C474 0C003148 */  jal        __osRestoreInt
