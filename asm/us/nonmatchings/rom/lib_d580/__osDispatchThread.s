...
glabel __osDispatchThread
    /* DD1C 8000D11C 3C048003 */  lui        $a0, %hi(__osActiveQueue)
    /* DD20 8000D120 0C003443 */  jal        __osPopThread
    /* DD24 8000D124 2484C3D8 */   addiu     $a0, $a0, %lo(__osActiveQueue)
    /* DD28 8000D128 3C018003 */  lui        $at, %hi(__osRunningThread)
    /* DD2C 8000D12C AC22C3E0 */  sw         $v0, %lo(__osRunningThread)($at)
    /* DD30 8000D130 24080004 */  addiu      $t0, $zero, 0x4
    /* DD34 8000D134 A4480010 */  sh         $t0, 0x10($v0)
    /* DD38 8000D138 0040D025 */  or         $k0, $v0, $zero
    /* DD3C 8000D13C 3C088003 */  lui        $t0, %hi(__osGlobalIntMask)
    /* DD40 8000D140 8F5B0118 */  lw         $k1, 0x118($k0) /* handwritten instruction */
    /* DD44 8000D144 2508C370 */  addiu      $t0, $t0, %lo(__osGlobalIntMask)
  ...
  .L8000D24C:
    ...
    /* DE50 8000D250 3C1A8003 */  lui        $k0, %hi(__osGlobalIntMask) /* handwritten instruction */
    /* DE54 8000D254 275AC370 */  addiu      $k0, $k0, %lo(__osGlobalIntMask) /* handwritten instruction */
    ...
    /* DE68 8000D268 3C1A8003 */  lui        $k0, %hi(__osRcpImTable) /* handwritten instruction */
    /* DE6C 8000D26C 275AD6D0 */  addiu      $k0, $k0, %lo(__osRcpImTable) /* handwritten instruction */
