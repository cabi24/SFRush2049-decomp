...
nonmatching __osExceptionPreamble, 0x54C

glabel __osExceptionPreamble
    /* D590 8000C990 3C1A8003 */  lui        $k0, %hi(__osExceptionSaveArea) /* handwritten instruction */
    /* D594 8000C994 275A7DB0 */  addiu      $k0, $k0, %lo(__osExceptionSaveArea) /* handwritten instruction */
    ...
    /* D5C8 8000C9C8 3C1A8003 */  lui        $k0, %hi(__osRunningThread) /* handwritten instruction */
    /* D5CC 8000C9CC 8F5AC3E0 */  lw         $k0, %lo(__osRunningThread)($k0) /* handwritten instruction */
    ...
    /* D678 8000CA78 3C088003 */  lui        $t0, %hi(__osGlobalIntMask)
    /* D67C 8000CA7C 2508C370 */  addiu      $t0, $t0, %lo(__osGlobalIntMask)
  ...
  .L8000CAB8:
    ...
    /* D6C8 8000CAC8 3C088003 */  lui        $t0, %hi(__osGlobalIntMask)
    /* D6CC 8000CACC 2508C370 */  addiu      $t0, $t0, %lo(__osGlobalIntMask)
  ...
  .L8000CBA8:
    /* D7A8 8000CBA8 3C018003 */  lui        $at, %hi(__osIntOffTable)
    /* D7AC 8000CBAC 002A0821 */  addu       $at, $at, $t2
    /* D7B0 8000CBB0 902AD810 */  lbu        $t2, %lo(__osIntOffTable)($at)
    ...
    /* D7E8 8000CBE8 0C0033B7 */  jal        __osSendInterrupt
    ...
    /* D800 8000CC00 3C098003 */  lui        $t1, %hi(__osHwIntTable)
    /* D804 8000CC04 2529C470 */  addiu      $t1, $t1, %lo(__osHwIntTable)
  ...
  .L8000CC34:
    /* D834 8000CC34 0C0033B7 */  jal        __osSendInterrupt
    /* D838 8000CC38 24040010 */   addiu     $a0, $zero, 0x10
    /* D83C 8000CC3C 1000FFD4 */  b          .L8000CB90
    /* D840 8000CC40 00000000 */   nop
    /* D844 8000CC44 3C088003 */  lui        $t0, %hi(__osGlobalIntMask)
    /* D848 8000CC48 2508C370 */  addiu      $t0, $t0, %lo(__osGlobalIntMask)
    ...
    /* D88C 8000CC8C 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CCA4:
    /* D8A4 8000CCA4 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CCB4:
    ...
    /* D8C8 8000CCC8 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CCD8:
    ...
    /* D8F4 8000CCF4 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CD04:
    ...
    /* D918 8000CD18 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CD28:
    ...
    /* D940 8000CD40 3C098003 */  lui        $t1, %hi(__osPiIntHandler)
    /* D944 8000CD44 2529C498 */  addiu      $t1, $t1, %lo(__osPiIntHandler)
  ...
  .L8000CD6C:
    /* D96C 8000CD6C 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CD7C:
    ...
    /* D998 8000CD98 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CDD8:
    ...
    /* D9E0 8000CDE0 0C0033B7 */  jal        __osSendInterrupt
    /* D9E4 8000CDE4 24040070 */   addiu     $a0, $zero, 0x70
    /* D9E8 8000CDE8 3C0A8003 */  lui        $t2, %hi(__osActiveQueue)
    /* D9EC 8000CDEC 8D4AC3D8 */  lw         $t2, %lo(__osActiveQueue)($t2)
    ...
    /* DA14 8000CE14 0C0033B7 */  jal        __osSendInterrupt
    ...
    /* DA34 8000CE34 0C0033B7 */  jal        __osSendInterrupt
  ...
  .L8000CE48:
    ...
    /* DA50 8000CE50 0C0033B7 */  jal        __osSendInterrupt
    /* DA54 8000CE54 24040050 */   addiu     $a0, $zero, 0x50
    /* DA58 8000CE58 10000001 */  b          .L8000CE60
    /* DA5C 8000CE5C 00000000 */   nop
  .L8000CE60:
    /* DA60 8000CE60 3C0A8003 */  lui        $t2, %hi(__osActiveQueue)
    /* DA64 8000CE64 8D4AC3D8 */  lw         $t2, %lo(__osActiveQueue)($t2)
    ...
    /* DA7C 8000CE7C 3C048003 */  lui        $a0, %hi(__osActiveQueue)
    /* DA80 8000CE80 03402825 */  or         $a1, $k0, $zero
    /* DA84 8000CE84 0C003431 */  jal        __osEnqueueThread
    /* DA88 8000CE88 2484C3D8 */   addiu     $a0, $a0, %lo(__osActiveQueue)
    /* DA8C 8000CE8C 08003447 */  j          __osDispatchThread
    /* DA90 8000CE90 00000000 */   nop
  .L8000CE94:
    /* DA94 8000CE94 3C098003 */  lui        $t1, %hi(__osActiveQueue)
    /* DA98 8000CE98 2529C3D8 */  addiu      $t1, $t1, %lo(__osActiveQueue)
    /* DA9C 8000CE9C 8D2A0000 */  lw         $t2, 0x0($t1)
    /* DAA0 8000CEA0 AF4A0000 */  sw         $t2, 0x0($k0) /* handwritten instruction */
    /* DAA4 8000CEA4 08003447 */  j          __osDispatchThread
    /* DAA8 8000CEA8 AD3A0000 */   sw        $k0, 0x0($t1) /* handwritten instruction */
  .L8000CEAC:
    /* DAAC 8000CEAC 3C018003 */  lui        $at, %hi(__osFaultedThread)
    /* DAB0 8000CEB0 AC3AC3E4 */  sw         $k0, %lo(__osFaultedThread)($at) /* handwritten instruction */
    ...
    /* DACC 8000CECC 0C0033B7 */  jal        __osSendInterrupt
    /* DAD0 8000CED0 24040060 */   addiu     $a0, $zero, 0x60
    /* DAD4 8000CED4 08003447 */  j          __osDispatchThread
