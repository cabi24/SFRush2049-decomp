...
nonmatching __osCleanupThread, 0x100

glabel __osCleanupThread
    /* DBC4 8000CFC4 3C058003 */  lui        $a1, %hi(__osRunningThread)
    /* DBC8 8000CFC8 8CA5C3E0 */  lw         $a1, %lo(__osRunningThread)($a1)
  ...
  .L8000D034:
    ...
    /* DC44 8000D044 3C088003 */  lui        $t0, %hi(__osGlobalIntMask)
    /* DC48 8000D048 2508C370 */  addiu      $t0, $t0, %lo(__osGlobalIntMask)
  ...
  .L8000D074:
    ...
    /* DC84 8000D084 3C1A8003 */  lui        $k0, %hi(__osGlobalIntMask) /* handwritten instruction */
    /* DC88 8000D088 275AC370 */  addiu      $k0, $k0, %lo(__osGlobalIntMask) /* handwritten instruction */
  ...
  .L8000D0AC:
    ...
    /* DCB4 8000D0B4 0C003431 */  jal        __osEnqueueThread
    /* DCB8 8000D0B8 00000000 */   nop
  .L8000D0BC:
    /* DCBC 8000D0BC 08003447 */  j          __osDispatchThread
