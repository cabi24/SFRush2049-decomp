...
nonmatching __osSendInterrupt, 0xE8

glabel __osSendInterrupt
    /* DADC 8000CEDC 3C0A8003 */  lui        $t2, %hi(__osEventStateTab)
    /* DAE0 8000CEE0 254A6710 */  addiu      $t2, $t2, %lo(__osEventStateTab)
  ...
  .L8000CF3C:
    ...
    /* DB6C 8000CF6C 0C003443 */  jal        __osPopThread
    /* DB70 8000CF70 01202025 */   or        $a0, $t1, $zero
    /* DB74 8000CF74 00405025 */  or         $t2, $v0, $zero
    /* DB78 8000CF78 3C048003 */  lui        $a0, %hi(__osActiveQueue)
    /* DB7C 8000CF7C 01402825 */  or         $a1, $t2, $zero
    /* DB80 8000CF80 0C003431 */  jal        __osEnqueueThread
    /* DB84 8000CF84 2484C3D8 */   addiu     $a0, $a0, %lo(__osActiveQueue)
  .L8000CF88:
