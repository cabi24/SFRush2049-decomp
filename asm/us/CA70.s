...
nonmatching osAiSetNextBuffer, 0x90
...
glabel osAiSetNextBuffer
    ...
    /* CA7C 8000BE7C 0C003ED8 */  jal        __osAiDeviceBusy
  ...
  .L8000BE94:
    /* CA94 8000BE94 3C0E8003 */  lui        $t6, %hi(__osAiNeedsAlign)
    /* CA98 8000BE98 91CEC3C0 */  lbu        $t6, %lo(__osAiNeedsAlign)($t6)
  ...
  .L8000BEB0:
    ...
    /* CAB8 8000BEB8 3C018003 */   lui       $at, %hi(__osAiNeedsAlign)
    /* CABC 8000BEBC 24080001 */  addiu      $t0, $zero, 0x1
    /* CAC0 8000BEC0 3C018003 */  lui        $at, %hi(__osAiNeedsAlign)
    /* CAC4 8000BEC4 10000002 */  b          .L8000BED0
    /* CAC8 8000BEC8 A028C3C0 */   sb        $t0, %lo(__osAiNeedsAlign)($at)
  .L8000BECC:
    /* CACC 8000BECC A020C3C0 */  sb         $zero, %lo(__osAiNeedsAlign)($at)
  .L8000BED0:
    /* CAD0 8000BED0 0C003570 */  jal        osVirtualToPhysical
...
glabel osAiSetFrequency
    /* CB00 8000BF00 3C058003 */  lui        $a1, %hi(gAudioDmaBufferPtr)
    /* CB04 8000BF04 24A5C368 */  addiu      $a1, $a1, %lo(gAudioDmaBufferPtr)
