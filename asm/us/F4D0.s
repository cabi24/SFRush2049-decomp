...
glabel __osContRamRead
    ...
    /* F50C 8000E90C 0C00396C */  jal        __osSiGetAccess
    /* F510 8000E910 24150002 */   addiu     $s5, $zero, 0x2
    /* F514 8000E914 97A5006A */  lhu        $a1, 0x6A($sp)
    /* F518 8000E918 3C1E8003 */  lui        $fp, %hi(__osContLastChannel)
    /* F51C 8000E91C 3C178003 */  lui        $s7, %hi(__osPfsRequestType)
    /* F520 8000E920 3C148003 */  lui        $s4, %hi(__osPfsBuffer)
    ...
    /* F534 8000E934 26947F60 */  addiu      $s4, $s4, %lo(__osPfsBuffer)
    /* F538 8000E938 26F77AE0 */  addiu      $s7, $s7, %lo(__osPfsRequestType)
    /* F53C 8000E93C 27DEC4C0 */  addiu      $fp, $fp, %lo(__osContLastChannel)
  .L8000E940:
  ...
  .L8000E9EC:
    ...
    /* F5F4 8000E9F4 0C003E7C */  jal        __osContAddressCrc
    ...
    /* F658 8000EA58 0C003EB0 */  jal        __osPfsDataChecksum
    ...
    /* F678 8000EA78 0C003988 */  jal        osContStartReadData
  ...
  .L8000EA90:
    /* F690 8000EA90 0C0034AC */  jal        bcopy
  ...
  .L8000EAB8:
    /* F6B8 8000EAB8 0C00397D */  jal        __osSiRelAccess
