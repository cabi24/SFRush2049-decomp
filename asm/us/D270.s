...
glabel __osViSwapContext
    ...
    /* D27C 8000C67C 3C108003 */  lui        $s0, %hi(__osViContext)
    /* D280 8000C680 3C0EA440 */  lui        $t6, %hi(VI_CURRENT_REG)
    /* D284 8000C684 8E10C464 */  lw         $s0, %lo(__osViContext)($s0)
    ...
    /* D29C 8000C69C 0C003570 */  jal        osVirtualToPhysical
  ...
  .L8000C7D8:
    /* D3D8 8000C7D8 3C028003 */  lui        $v0, %hi(gViMgrEventCount)
    /* D3DC 8000C7DC 8C42C34C */  lw         $v0, %lo(gViMgrEventCount)($v0)
  ...
  .L8000C80C:
    ...
    /* D424 8000C824 0C003570 */  jal        osVirtualToPhysical
  ...
  .L8000C844:
    ...
    /* D46C 8000C86C 0C003570 */  jal        osVirtualToPhysical
  ...
  .L8000C888:
    ...
    /* D4C4 8000C8C4 3C028003 */  lui        $v0, %hi(__osViModeInfo)
    ...
    /* D4D4 8000C8D4 2442C460 */  addiu      $v0, $v0, %lo(__osViModeInfo)
    ...
    /* D4E8 8000C8E8 3C038003 */  lui        $v1, %hi(__osViContext)
    /* D4EC 8000C8EC AD190028 */  sw         $t9, %lo(VI_V_START_REG)($t0)
    /* D4F0 8000C8F0 8CC90034 */  lw         $t1, 0x34($a2)
    /* D4F4 8000C8F4 2463C464 */  addiu      $v1, $v1, %lo(__osViContext)
