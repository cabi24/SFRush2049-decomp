...
glabel entrypoint
    /* 1000 80000400 3C088003 */  lui        $t0, %hi(__osScRetraceTimeHi)
    /* 1004 80000404 3C090005 */  lui        $t1, (0x58170 >> 16)
    /* 1008 80000408 2508E8E0 */  addiu      $t0, $t0, %lo(__osScRetraceTimeHi)
  ...
  .L80000410:
    ...
    /* 1028 80000428 3C1D8008 */  lui        $sp, %hi(gDecompressedDataStart)
    /* 102C 8000042C 254A20F0 */  addiu      $t2, $t2, %lo(main)
    /* 1030 80000430 01400008 */  jr         $t2
    /* 1034 80000434 27BD6A50 */   addiu     $sp, $sp, %lo(gDecompressedDataStart)
endlabel entrypoint
