...
nonmatching osViInit, 0x114

glabel osViInit
    /* D140 8000C540 27BDFFE8 */  addiu      $sp, $sp, -0x18
    /* D144 8000C544 AFBF0014 */  sw         $ra, 0x14($sp)
    /* D148 8000C548 3C048003 */  lui        $a0, %hi(__osViMode)
    /* D14C 8000C54C 2484C400 */  addiu      $a0, $a0, %lo(__osViMode)
    /* D150 8000C550 0C002164 */  jal        bzero
    /* D154 8000C554 24050060 */   addiu     $a1, $zero, 0x60
    /* D158 8000C558 3C028003 */  lui        $v0, %hi(__osViModeInfo)
    /* D15C 8000C55C 3C048003 */  lui        $a0, %hi(__osViContext)
    /* D160 8000C560 3C0E8003 */  lui        $t6, %hi(__osViMode)
    /* D164 8000C564 3C0F8003 */  lui        $t7, %hi(__osViModeTable)
    /* D168 8000C568 2484C464 */  addiu      $a0, $a0, %lo(__osViContext)
    /* D16C 8000C56C 2442C460 */  addiu      $v0, $v0, %lo(__osViModeInfo)
    /* D170 8000C570 25CEC400 */  addiu      $t6, $t6, %lo(__osViMode)
    /* D174 8000C574 25EFC430 */  addiu      $t7, $t7, %lo(__osViModeTable)
    ...
    /* D19C 8000C59C 3C0A8003 */  lui        $t2, %hi(__osViModePending)
    ...
    /* D1C0 8000C5C0 254AC4E0 */  addiu      $t2, $t2, %lo(__osViModePending)
    /* D1C4 8000C5C4 1000000B */  b          .L8000C5F4
    /* D1C8 8000C5C8 AD6A0008 */   sw        $t2, 0x8($t3)
  .L8000C5CC:
    /* D1CC 8000C5CC 14610005 */  bne        $v1, $at, .L8000C5E4
    /* D1D0 8000C5D0 3C0C8003 */   lui       $t4, %hi(__osViModeNext)
    /* D1D4 8000C5D4 8C8D0000 */  lw         $t5, 0x0($a0)
    /* D1D8 8000C5D8 258CC530 */  addiu      $t4, $t4, %lo(__osViModeNext)
    /* D1DC 8000C5DC 10000005 */  b          .L8000C5F4
    /* D1E0 8000C5E0 ADAC0008 */   sw        $t4, 0x8($t5)
  .L8000C5E4:
    /* D1E4 8000C5E4 8C8F0000 */  lw         $t7, 0x0($a0)
    /* D1E8 8000C5E8 3C0E8003 */  lui        $t6, %hi(__osViModeBuffer)
    /* D1EC 8000C5EC 25CEC580 */  addiu      $t6, $t6, %lo(__osViModeBuffer)
  ...
  .L8000C63C:
    /* D23C 8000C63C 0C00319C */  jal        __osViSwapContext
