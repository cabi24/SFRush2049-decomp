...
nonmatching display_update, 0x554

glabel display_update
  ...
  .L80001610:
    ...
    /* 22F8 800016F8 0C001C74 */  jal        osSetGlobalIntMask
  ...
  .L80001744:
    ...
    /* 2354 80001754 0C001F1A */  jal        memcpy
  ...
  .L80001ABC:
    ...
    /* 271C 80001B1C 0C001F28 */  jal        osWritebackDCache
    /* 2720 80001B20 24050050 */   addiu     $a1, $zero, 0x50
    /* 2724 80001B24 0C001C74 */  jal        osSetGlobalIntMask
...
endlabel display_update

nonmatching viewport_setup, 0x21C

glabel viewport_setup
  ...
  .L80001CE4:
    ...
    /* 2920 80001D20 0C029D42 */  jal        viewport_scale
  ...
  .L80001D28:
    ...
    /* 2940 80001D40 0C00057C */  jal        display_update
...
endlabel viewport_setup

nonmatching display_mode_tick, 0x9C

glabel display_mode_tick
...
endlabel display_mode_tick

nonmatching get_tv_offset, 0x5C

glabel get_tv_offset
...
endlabel get_tv_offset

nonmatching apply_display_mode, 0x2C

glabel apply_display_mode
    ...
    /* 2A64 80001E64 0C001B50 */  jal        osSetThreadPri
...
endlabel apply_display_mode

nonmatching get_viewport_pos, 0x48

glabel get_viewport_pos
...
endlabel get_viewport_pos

nonmatching get_viewport_offset, 0x60

glabel get_viewport_offset
...
endlabel get_viewport_offset

nonmatching update_viewport, 0x1C0

glabel update_viewport
  ...
  .L800020CC:
    /* 2CCC 800020CC 0C00057C */  jal        display_update
