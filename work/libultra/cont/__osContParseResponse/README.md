...
./work/libultra/cont/__osContParseResponse/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/cont/__osContParseResponse

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/cont/__osContParseResponse --watch
```
