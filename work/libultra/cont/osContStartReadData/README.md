...
./work/libultra/cont/osContStartReadData/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/cont/osContStartReadData

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/cont/osContStartReadData --watch
```
