...
./work/libultra/cont/__osContBuildRequest/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/cont/__osContBuildRequest

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/cont/__osContBuildRequest --watch
```
