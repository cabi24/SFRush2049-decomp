...
./work/libultra/motor/__osMotorAccess/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/motor/__osMotorAccess

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/motor/__osMotorAccess --watch
```
