...
rumble pak motor initialization
...
./work/libultra/motor/osMotorInit/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/motor/osMotorInit

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/motor/osMotorInit --watch
```
