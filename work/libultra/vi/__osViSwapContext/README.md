...
swap VI context (writes to VI hardware registers)
...
./work/libultra/vi/__osViSwapContext/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/vi/__osViSwapContext

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/vi/__osViSwapContext --watch
```
