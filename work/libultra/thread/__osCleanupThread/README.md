...
save thread context and check for dispatch (exception cleanup)
...
./work/libultra/thread/__osCleanupThread/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/thread/__osCleanupThread

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/thread/__osCleanupThread --watch
```
