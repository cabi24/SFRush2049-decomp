...
enqueue thread to priority queue
...
./work/libultra/thread/__osEnqueueThread/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/thread/__osEnqueueThread

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/thread/__osEnqueueThread --watch
```
