...
./work/libultra/cache/osWritebackDCache/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/cache/osWritebackDCache

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/cache/osWritebackDCache --watch
```
