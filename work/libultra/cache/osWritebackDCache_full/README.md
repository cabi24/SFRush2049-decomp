...
./work/libultra/cache/osWritebackDCache_full/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/cache/osWritebackDCache_full

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/cache/osWritebackDCache_full --watch
```
