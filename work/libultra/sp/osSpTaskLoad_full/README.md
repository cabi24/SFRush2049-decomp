...
load RSP task microcode and data
...
./work/libultra/sp/osSpTaskLoad_full/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/sp/osSpTaskLoad_full

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/sp/osSpTaskLoad_full --watch
```
