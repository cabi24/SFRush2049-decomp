...
./work/libultra/sp/__osSpDma/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/sp/__osSpDma

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/sp/__osSpDma --watch
```
