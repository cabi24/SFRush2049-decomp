...
orthographic projection matrix (fixed-point)
...
./work/libultra/gu/guOrtho/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/gu/guOrtho

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/gu/guOrtho --watch
```
