...
check if AI FIFO is full (returns 1 if busy)
...
./work/libultra/ai/__osAiDeviceBusy/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/ai/__osAiDeviceBusy

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/ai/__osAiDeviceBusy --watch
```
