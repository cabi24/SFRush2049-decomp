...
./work/libultra/timer/__osTimerInterrupt/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/timer/__osTimerInterrupt

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/timer/__osTimerInterrupt --watch
```
