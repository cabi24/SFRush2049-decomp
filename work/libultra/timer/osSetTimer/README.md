...
set timer (initializes OSTimer and inserts to queue)
...
./work/libultra/timer/osSetTimer/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/timer/osSetTimer

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/timer/osSetTimer --watch
```
