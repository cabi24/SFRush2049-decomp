...
./work/libultra/timer/entity_timer_update/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/timer/entity_timer_update

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/timer/entity_timer_update --watch
```
