...
byte-sum checksum helper (used by PFS)
...
./work/libultra/os/__osSumcalc/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/os/__osSumcalc

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/os/__osSumcalc --watch
```
