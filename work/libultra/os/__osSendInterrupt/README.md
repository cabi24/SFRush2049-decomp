...
send interrupt message to event state table queue (called from exception handler)
...
./work/libultra/os/__osSendInterrupt/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/os/__osSendInterrupt

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/os/__osSendInterrupt --watch
```
