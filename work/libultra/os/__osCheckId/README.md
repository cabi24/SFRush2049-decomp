...
check ID consistency across 4 pages
...
./work/libultra/os/__osCheckId/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/os/__osCheckId

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/os/__osCheckId --watch
```
