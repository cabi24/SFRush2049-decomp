...
repair/rewrite ID to 4 redundant pages
...
./work/libultra/os/__osRepairId/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/os/__osRepairId

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/os/__osRepairId --watch
```
