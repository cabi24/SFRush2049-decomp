...
./work/libultra/os/osPhysicalToVirtual/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/os/osPhysicalToVirtual

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/os/osPhysicalToVirtual --watch
```
