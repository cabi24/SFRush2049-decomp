...
./work/libultra/pi/osPiGetAccess/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pi/osPiGetAccess

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pi/osPiGetAccess --watch
```
