...
configure PI bus timing registers
...
./work/libultra/pi/osPiSetDeviceTiming/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pi/osPiSetDeviceTiming

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pi/osPiSetDeviceTiming --watch
```
