...
read/write controller pak file pages
...
./work/libultra/pfs/osPfsReadWriteFile_pages/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/osPfsReadWriteFile_pages

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/osPfsReadWriteFile_pages --watch
```
