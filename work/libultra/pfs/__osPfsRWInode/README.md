...
read/write controller pak inode table
...
./work/libultra/pfs/__osPfsRWInode/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/__osPfsRWInode

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/__osPfsRWInode --watch
```
