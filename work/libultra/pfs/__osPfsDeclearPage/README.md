...
page allocation helper for file allocation
...
./work/libultra/pfs/__osPfsDeclearPage/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/__osPfsDeclearPage

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/__osPfsDeclearPage --watch
```
