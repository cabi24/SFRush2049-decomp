...
get/verify controller pak file state
...
./work/libultra/pfs/osPfsFileState/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/osPfsFileState

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/osPfsFileState --watch
```
