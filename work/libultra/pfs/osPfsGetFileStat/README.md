...
get controller pak file status
...
./work/libultra/pfs/osPfsGetFileStat/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/osPfsGetFileStat

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/osPfsGetFileStat --watch
```
