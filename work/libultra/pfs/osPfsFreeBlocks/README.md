...
get free blocks on controller pak
...
./work/libultra/pfs/osPfsFreeBlocks/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/osPfsFreeBlocks

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/osPfsFreeBlocks --watch
```
