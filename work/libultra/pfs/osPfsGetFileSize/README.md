...
./work/libultra/pfs/osPfsGetFileSize/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/pfs/osPfsGetFileSize

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/pfs/osPfsGetFileSize --watch
```
