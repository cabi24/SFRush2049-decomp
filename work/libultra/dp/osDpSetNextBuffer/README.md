...
./work/libultra/dp/osDpSetNextBuffer/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libultra/dp/osDpSetNextBuffer

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libultra/dp/osDpSetNextBuffer --watch
```
