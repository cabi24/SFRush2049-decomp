...
countdown and apply pending display mode
...
./work/boot/display_mode_tick/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/boot/display_mode_tick

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/boot/display_mode_tick --watch
```
