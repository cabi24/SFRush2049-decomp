...
return TV-type specific offset (0 for PAL=0, 0xE for NTSC, 0x1C for other)
...
./work/boot/get_tv_offset/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/boot/get_tv_offset

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/boot/get_tv_offset --watch
```
