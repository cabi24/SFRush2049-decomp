...
copy memory with overlap handling (memmove)
...
./work/libc/bcopy/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/libc/bcopy

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/libc/bcopy --watch
```
