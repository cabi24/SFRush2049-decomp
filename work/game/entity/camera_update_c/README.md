...
./work/game/entity/camera_update_c/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/camera_update_c

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/camera_update_c --watch
```
