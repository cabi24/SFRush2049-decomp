...
./work/game/entity/lighting_setup/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/lighting_setup

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/lighting_setup --watch
```
