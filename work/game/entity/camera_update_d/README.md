...
./work/game/entity/camera_update_d/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/camera_update_d

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/camera_update_d --watch
```
