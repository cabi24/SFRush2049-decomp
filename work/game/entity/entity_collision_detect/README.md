...
entity collision detection (820 bytes)
...
./work/game/entity/entity_collision_detect/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/entity_collision_detect

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/entity_collision_detect --watch
```
