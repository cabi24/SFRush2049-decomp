...
./work/game/entity/npc_interaction/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/npc_interaction

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/npc_interaction --watch
```
