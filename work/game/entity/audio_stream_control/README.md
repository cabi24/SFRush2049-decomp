...
audio streaming control (236 bytes)
...
./work/game/entity/audio_stream_control/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_stream_control

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_stream_control --watch
```
