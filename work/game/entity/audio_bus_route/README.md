...
./work/game/entity/audio_bus_route/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_bus_route

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_bus_route --watch
```
