...
tire/drag forces (arcade: forces1 in drivsym.c:391)
...
./work/game/entity/physics_forces1/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/physics_forces1

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/physics_forces1 --watch
```
