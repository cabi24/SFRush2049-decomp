...
sound priority management (236 bytes)
...
./work/game/entity/sound_priority_set/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/sound_priority_set

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/sound_priority_set --watch
```
