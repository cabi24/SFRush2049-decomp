...
3D sound position update (492 bytes)
...
./work/game/entity/sound_position_update/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/sound_position_update

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/sound_position_update --watch
```
