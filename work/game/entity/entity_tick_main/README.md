...
major entity processing loop (2684 bytes)
...
./work/game/entity/entity_tick_main/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/entity_tick_main

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/entity_tick_main --watch
```
