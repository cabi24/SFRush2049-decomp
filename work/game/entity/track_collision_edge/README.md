...
./work/game/entity/track_collision_edge/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/track_collision_edge

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/track_collision_edge --watch
```
