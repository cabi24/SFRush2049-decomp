...
entity collision response (876 bytes)
...
./work/game/entity/entity_collision_response/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/entity_collision_response

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/entity_collision_response --watch
```
