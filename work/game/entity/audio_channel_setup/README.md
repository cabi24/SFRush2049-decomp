...
audio parameter setup (460 bytes)
...
./work/game/entity/audio_channel_setup/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_channel_setup

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_channel_setup --watch
```
