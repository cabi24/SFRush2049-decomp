...
./work/game/entity/engine_sound_sync/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/engine_sound_sync

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/engine_sound_sync --watch
```
