...
audio timing sync with video (184 bytes)
...
./work/game/entity/audio_timing_sync/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_timing_sync

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_timing_sync --watch
```
