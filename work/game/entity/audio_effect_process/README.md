...
./work/game/entity/audio_effect_process/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_effect_process

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_effect_process --watch
```
