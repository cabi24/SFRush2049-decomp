...
./work/game/entity/audio_loop_control/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_loop_control

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_loop_control --watch
```
