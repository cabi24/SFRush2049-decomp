...
entity AI/behavior update for drones (3440 bytes)
...
./work/game/entity/drone_ai_update/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/drone_ai_update

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/drone_ai_update --watch
```
