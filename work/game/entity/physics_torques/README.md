...
calculate moments (arcade: torques in drivsym.c:530)
...
./work/game/entity/physics_torques/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/physics_torques

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/physics_torques --watch
```
