...
./work/game/entity/audio_buffer_sync/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_buffer_sync

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_buffer_sync --watch
```
