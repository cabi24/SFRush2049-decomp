...
audio volume and pan control (668 bytes)
...
./work/game/entity/audio_volume_pan/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_volume_pan

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_volume_pan --watch
```
