...
audio state save/restore (468 bytes)
...
./work/game/entity/audio_state_save/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_state_save

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_state_save --watch
```
