...
./work/game/entity/bgm_playback/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/bgm_playback

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/bgm_playback --watch
```
