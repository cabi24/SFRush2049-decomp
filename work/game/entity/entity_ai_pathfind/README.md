...
entity AI pathfinding (2388 bytes)
...
./work/game/entity/entity_ai_pathfind/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/entity_ai_pathfind

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/entity_ai_pathfind --watch
```
