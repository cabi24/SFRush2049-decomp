...
./work/game/entity/audio_queue_recv/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_queue_recv

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_queue_recv --watch
```
