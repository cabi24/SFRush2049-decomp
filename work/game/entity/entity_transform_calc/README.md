...
./work/game/entity/entity_transform_calc/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/entity_transform_calc

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/entity_transform_calc --watch
```
