...
3D sound position/volume update
...
./work/game/entity/sound_3d_update/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/sound_3d_update

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/sound_3d_update --watch
```
