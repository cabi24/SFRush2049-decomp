...
float-heavy physics calculation
...
./work/game/entity/physics_float_calc/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/physics_float_calc

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/physics_float_calc --watch
```
