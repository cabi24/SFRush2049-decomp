...
./work/game/entity/physics_forces_handler_B/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/physics_forces_handler_B

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/physics_forces_handler_B --watch
```
