...
./work/game/entity/voice_playback/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/voice_playback

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/voice_playback --watch
```
