...
world/environment collision detection
...
./work/game/entity/world_collision/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/world_collision

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/world_collision --watch
```
