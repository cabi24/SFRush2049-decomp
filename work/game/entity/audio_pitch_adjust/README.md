...
audio pitch adjustment (72 bytes)
...
./work/game/entity/audio_pitch_adjust/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_pitch_adjust

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_pitch_adjust --watch
```
