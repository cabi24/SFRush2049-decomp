...
./work/game/entity/audio_init_stub/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/audio_init_stub

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/audio_init_stub --watch
```
