...
./work/game/entity/particle_system/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/particle_system

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/particle_system --watch
```
