...
sum all forces (arcade: forces2 in drivsym.c:494)
...
./work/game/entity/physics_forces2/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/entity/physics_forces2

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/entity/physics_forces2 --watch
```
