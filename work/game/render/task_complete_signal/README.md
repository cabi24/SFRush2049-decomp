...
./work/game/render/task_complete_signal/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/task_complete_signal

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/task_complete_signal --watch
```
