...
forwards to downstream audio routine
...
./work/game/render/audio_call_wrapper/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/audio_call_wrapper

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/audio_call_wrapper --watch
```
