...
./work/game/render/audio_param_apply/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/audio_param_apply

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/audio_param_apply --watch
```
