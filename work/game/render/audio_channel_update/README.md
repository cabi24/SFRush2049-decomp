...
./work/game/render/audio_channel_update/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/audio_channel_update

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/audio_channel_update --watch
```
