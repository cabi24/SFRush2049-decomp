...
./work/game/render/texture_load_start/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/texture_load_start

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/texture_load_start --watch
```
