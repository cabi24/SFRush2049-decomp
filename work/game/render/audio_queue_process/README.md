...
audio queue processing (676 bytes)
...
./work/game/render/audio_queue_process/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/audio_queue_process

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/audio_queue_process --watch
```
