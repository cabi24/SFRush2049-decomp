...
major entity processing (1524 bytes)
...
./work/game/render/entity_process_main/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/entity_process_main

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/entity_process_main --watch
```
