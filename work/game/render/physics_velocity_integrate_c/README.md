...
./work/game/render/physics_velocity_integrate_c/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/physics_velocity_integrate_c

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/physics_velocity_integrate_c --watch
```
