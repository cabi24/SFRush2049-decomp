...
./work/game/render/physics_velocity_integrate_d/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/physics_velocity_integrate_d

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/physics_velocity_integrate_d --watch
```
