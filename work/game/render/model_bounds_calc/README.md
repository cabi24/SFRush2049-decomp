...
./work/game/render/model_bounds_calc/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/model_bounds_calc

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/model_bounds_calc --watch
```
