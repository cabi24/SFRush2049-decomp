...
./work/game/render/dma_wait_complete/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/dma_wait_complete

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/dma_wait_complete --watch
```
