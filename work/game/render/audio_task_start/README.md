...
./work/game/render/audio_task_start/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/render/audio_task_start

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/render/audio_task_start --watch
```
