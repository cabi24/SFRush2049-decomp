...
./work/game/ai/menu_audio_options/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/ai/menu_audio_options

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/ai/menu_audio_options --watch
```
