...
./work/game/ai/main_menu_handler/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/ai/main_menu_handler

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/ai/main_menu_handler --watch
```
