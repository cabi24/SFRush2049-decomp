...
processes main menu input (224 bytes)
...
./work/game/ai/main_menu_input/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/game/ai/main_menu_input

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/game/ai/main_menu_input --watch
```
