...
insert timer into delta queue (__osInsertTimer)
...
./work/dll/dll_insert/compile.sh

# Or use asmdiff for side-by-side view:
python3 tools/asmdiff.py work/dll/dll_insert

# Watch mode (auto-refresh on save):
python3 tools/asmdiff.py work/dll/dll_insert --watch
```
